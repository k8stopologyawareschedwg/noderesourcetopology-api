...
type ZoneApplyConfiguration struct {
	...
	Costs      *topologyv1alpha1.CostList         `json:"costs,omitempty"`
	Attributes *topologyv1alpha1.AttributeList    `json:"attributes,omitempty"`
	Resources  *topologyv1alpha1.ResourceInfoList `json:"resources,omitempty"`
}
...
func (b *ZoneApplyConfiguration) WithCosts(value topologyv1alpha1.CostList) *ZoneApplyConfiguration {
	b.Costs = &value
	return b
}
...
func (b *ZoneApplyConfiguration) WithAttributes(value topologyv1alpha1.AttributeList) *ZoneApplyConfiguration {
	b.Attributes = &value
	return b
}
...
func (b *ZoneApplyConfiguration) WithResources(value topologyv1alpha1.ResourceInfoList) *ZoneApplyConfiguration {
	b.Resources = &value
	return b
}
