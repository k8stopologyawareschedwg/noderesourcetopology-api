...
type NodeResourceTopologyLister interface {
	...
	List(selector labels.Selector) (ret []*topologyv1alpha2.NodeResourceTopology, err error)
	// Get retrieves the NodeResourceTopology from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*topologyv1alpha2.NodeResourceTopology, error)
...
type nodeResourceTopologyLister struct {
	listers.ResourceIndexer[*topologyv1alpha2.NodeResourceTopology]
}
...
func NewNodeResourceTopologyLister(indexer cache.Indexer) NodeResourceTopologyLister {
	return &nodeResourceTopologyLister{listers.New[*topologyv1alpha2.NodeResourceTopology](indexer, topologyv1alpha2.Resource("noderesourcetopology"))}
}
